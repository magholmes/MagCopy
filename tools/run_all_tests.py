...
TESTS = ["smoke_platform_api.py", "smoke_gifinfo.py", "smoke_defaults.py", "smoke_permission.py", "smoke_own_windows.py", "smoke_escape_hatch.py", "smoke_hotkey_flow.py", "smoke_feedback.py", "smoke_frame.py", "smoke_overlay.py",
         "smoke_frame_live.py", "smoke_live_overlay.py", "smoke_frozen.py", "smoke_drag.py", "smoke_escape.py", "smoke_rebind.py", "smoke_flow.py",
