...
TESTS = ["smoke_gifinfo.py", "smoke_defaults.py", "smoke_permission.py", "smoke_own_windows.py", "smoke_escape_hatch.py", "smoke_hotkey_flow.py", "smoke_feedback.py", "smoke_frame.py", "smoke_overlay.py",
